...
namespace UnitTest.Integration.Repositories.DBConfiguration.EFCore
{
    public class EntityFrameworkConnection
    {
        ...
        public ApplicationContext DataBaseConfiguration()
        {
            ...
            IServiceCollection serviceCollections = services.AddDbContext<ApplicationContext>(options => options.UseSqlServer(DatabaseConnection.ConnectionConfiguration.Value.DefaultConnection));
